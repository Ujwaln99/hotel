...
def read_hashed_password():
    # Read the hashed password from the text file
...
if __name__ == '__main__':
    # Check if the password file exists, if not, create the password first.
    if not os.path.exists("password.txt"):
        create_password()
